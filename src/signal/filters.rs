...
const SG35: &'static [f64] = &[-3., 12., 17.];
const SG37: &'static [f64] = &[-2., 3., 6., 7.];
const SG39: &'static [f64] = &[-21., 14., 39., 54., 59.];
const SG311: &'static [f64] = &[-36., 9., 44., 69., 84., 89.];
const SG313: &'static [f64] = &[-11., 0., 9., 16., 21., 24., 25.];
const SG315: &'static [f64] = &[-78., -13., 42., 87., 122., 147., 162., 167.];
const SG317: &'static [f64] = &[-21., -6., 7., 18., 27., 34., 39., 42., 43.];
const SG319: &'static [f64] = &[-136., -51., 24., 89., 144., 189., 224., 249., 264., 269.];
const SG321: &'static [f64] = &[
    -171., -76., 9., 84., 149., 204., 249., 284., 309., 324., 329.,
];
const SG323: &'static [f64] = &[-42., -21., 2., 15., 30., 43., 54., 63., 70., 75., 78., 89.];
const SG325: &'static [f64] = &[
...
const SG57: &'static [f64] = &[5., -30., 75., 131.];
const SG59: &'static [f64] = &[15., -55., 30., 135., 179.];
const SG511: &'static [f64] = &[18., -45., -10., 60., 120., 143.];
const SG513: &'static [f64] = &[110., -198., -160., 110., 390., 600., 677.];
const SG515: &'static [f64] = &[2145., -2860., -2937., -165., 3755., 7500., 10125., 11063.];
const SG517: &'static [f64] = &[195., -195., -260., -117., 135., 415., 660., 825., 883.];
const SG519: &'static [f64] = &[
    340., -255., -420., -290., 18., 405., 790., 1110., 1320., 1393.,
];
const SG521: &'static [f64] = &[
    11628., -6460., -13005., -11220., -3940., 6378., 17655., 28190., 36660., 42120., 4403.,
];
const SG523: &'static [f64] = &[
    285., -114., -285., -285., -165., 30., 261., 495., 705., 870., 975., 1011.,
];
const SG525: &'static [f64] = &[
